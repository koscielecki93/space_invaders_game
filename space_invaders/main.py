...
for i in range(num_of_enemies):
    invadersImg.append(pygame.image.load('space-invaders.png'))
...
galacticImg = pygame.image.load('g.jpg')
...
score_Y = 10
#music
mixer.music.load("Jordan Baker - Explode [HD - Techno Classic Song] (online-audio-converter.com).wav")
mixer.music.play(-1)
